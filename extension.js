...
// e.g.: const APP = "org.gnome.Terminal.desktop";
...
var RAppButton = GObject.registerClass(
class RAppButton extends PanelMenu.Button {
	_init() {
		super._init(0.0, 'R App Button');
...
function enable() {
    _app_button = new RAppButton();
    Main.panel.addToStatusArea('r-app-button', _app_button);
}
